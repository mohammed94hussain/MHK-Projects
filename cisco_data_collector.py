...
for ip in ips:
    ...
    try:
        ...
        cdp_neighbors = {}
        if isinstance(show_cdp_neighbors, list):
            for neighbor in show_cdp_neighbors:
                if 'local_port' in neighbor and 'destination_host' in neighbor:
                    cdp_neighbors[neighbor['local_port']] = neighbor['destination_host']
